...
load("dr_mf_7.Rdata")
load("dr_mf_8.Rdata")
dr_mf_5 = abind(dr_mf_5, dr_mf_6, along=3)
dr_mf_6 = abind(dr_mf_7, dr_mf_8, along=3)
dr_mf = c(dr_mf_1, dr_mf_2, dr_mf_3, dr_mf_4, list(N_350=dr_mf_5), list(N_400=dr_mf_6))
...
load("dr_mr_4.Rdata")
load("dr_mr_5.Rdata")
dr_mr = c(dr_mr_1, dr_mr_2, dr_mr_3, dr_mr_4, dr_mr_5)
rm(dr_mr_1, dr_mr_2, dr_mr_3, dr_mr_4, dr_mr_5)
...
ggsave(file="figure2.eps", plot=grid.arrange(p1,p2,p3, nrow=3), width=18, 
       height=18, units="cm")
ggsave(file="figure3.eps", plot=p4)